...
const Home = () => {
	const data = useFetch(
		'http://localhost:1337/api/home-page?populate[reviews_items][populate]=*&populate[latest_projects_info_items][populate]=*&populate[latest_projects_images][populate]=*&populate[big_banner_image][populate]=*',
		{}
	);
